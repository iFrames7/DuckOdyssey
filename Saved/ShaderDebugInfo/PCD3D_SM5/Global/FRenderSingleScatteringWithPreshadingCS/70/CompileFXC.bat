...
%FXC% HeterogeneousVolumesPreshadingPipeline.usf /E RenderSingleScatteringWithPreshadingCS /Zpr /Gec /O3 /T cs_5_0 /Ni /FcHeterogeneousVolumesPreshadingPipeline.d3dasm 
 pause
:END
REM
